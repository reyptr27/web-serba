import { BiLogoYoutube, BiLogoInstagram, BiLogoTwitter, BiLogoTiktok } from "react-icons/bi";
      ...
      <nav className="bg-slate-600 p-4 sticky top-0 drop-shadow-xl z-10">
        <div className="md:px-6 prose prose-xl mx-auto flex justify-between flex-col sm:flex-row">
          ...
          <div className="flex flex-row justify-center sm:justify-evenly align-middle gap-4 text-white text-4xl lg:text-5xl">
            ...
            <Link className="text-white/90 hover:text-white" href="https://instagram.com/">
              <BiLogoInstagram />
            </Link>
            <Link className="text-white/90 hover:text-white" href="https://twitter.com/">
              <BiLogoTwitter />
            </Link>
            <Link className="text-white/90 hover:text-white" href="https://tiktok.com/">
              <BiLogoTiktok />
            </Link>
          </div>
        </div>
